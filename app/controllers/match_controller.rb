...
class MatchController < ApplicationController
  ...
  def match_products
    ...
    selected_products = products.map { |key, _value| key if products[key] == '1' }.to_a.compact
    new_products = products.map { |key, _value| key if products[key] == '0' }.to_a.compact
    ...
    new_products.each do |p|
      ref = p.split('_')[0]
      raw_product = RawProduct.find_by(id: ref)
