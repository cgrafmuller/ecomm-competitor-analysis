...
class Product < ApplicationRecord
  ...
  def self.save_store_products
    ...
    raw_products.each do |raw_product|
      product = Product.find_by(title: raw_product.product_title)
  ...
  def self.save_products
    ...
    evenheat = Manufacturer.find_by(name: 'Evenheat')
    jenken = Manufacturer.find_by(name: 'Jen-Ken')
    speedball = Manufacturer.find_by(name: 'Speedball')
    aim = Manufacturer.find_by(name: 'AIM')
  ...
  def self.save_product(raw_product_id)
    raw_product = RawProduct.find_by(id: raw_product_id)
    evenheat = Manufacturer.find_by(name: 'Evenheat')
    jenken = Manufacturer.find_by(name: 'Jen-Ken')
    speedball = Manufacturer.find_by(name: 'Speedball')
    # determine mfgr
